...
public enum ErrorCode {
  ...
  USER_NOT_MATCH(HttpStatus.FORBIDDEN, "해당 가게에 대한 권한이 없습니다."),
  ...
  STORE_OWNER_MISMATCH(HttpStatus.CONFLICT, "해당 메뉴 가게의 유저가 일치하지 않습니다."),
  MENU_NOT_FOUNT(HttpStatus.NOT_FOUND, "메뉴를 찾을 수 없습니다."),
